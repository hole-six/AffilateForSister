...
export const metadata: Metadata = {
  title: "Ưu Đãi & Mã Giảm Giá Shopee Mới Nhất — Nhím",
  description: "Cập nhật liên tục mã giảm giá, deal sập sàn Shopee. Mua qua link Nhím vừa được giá tốt vừa nhận thêm hoàn tiền.",
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Ưu đãi", item: "https://nhimhoahong.site/uu-dai" },
  ],
};
    ...
    formattedDeals.length > 0
      ? {
          ...
          itemListElement: formattedDeals.map((d, idx) => ({
            "@type": "ListItem",
            position: idx + 1,
            url: d.shortUrl || "https://nhimhoahong.site/uu-dai",
            name: d.title,
          })),
        }
      : null;
      ...
      <main className="pt-16 md:pt-[100px]">
        ...
        <section className="bg-gradient-to-b from-[#fdebf2] to-white py-3xl relative overflow-hidden">
          <div className="max-w-[1200px] mx-auto px-lg relative z-10 text-center">
            <img src="/nhimmagiamgia.png" alt="Ưu đãi và mã giảm giá Nhím" className="mx-auto h-24 w-24 object-contain mb-md" />
            ...
            <p className="text-[18px] text-mute max-w-2xl mx-auto leading-relaxed">
              Deal sập sàn Shopee được cập nhật mỗi ngày. Mua qua link Nhím vừa được giá tốt, vừa nhận thêm hoàn tiền.
            </p>
          </div>
        </section>
